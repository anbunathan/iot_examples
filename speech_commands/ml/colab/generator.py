...
class AudioProcessor(object):
  ...
  def __init__(self,
    ...
    self.prepare_data_index(silence_percentage, unknown_percentage,
                            ...
                            testing_percentage)
    print("prepare_data_index completed")
    
    self.prepare_background_data()
    print("prepare_background_data completed")
    
    self.prepare_processing_graph(model_settings)
    print("prepare_processing_graph completed")
  ...
  def prepare_data_index(self, silence_percentage, unknown_percentage,
    ...
    print("word_to_index = ", self.word_to_index)
  ...
  def prepare_processing_graph(self, model_settings):
    ...
    print("shape of self.spectrogram_ = ", tf.shape(self.spectrogram_))
    # input("Press Enter to continue...")
